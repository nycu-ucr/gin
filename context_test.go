...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/nycu-ucr/gin.handlerNameTest$", c.HandlerName())
}
...
func TestContextInitQueryCache(t *testing.T) {
	validURL, err := url.Parse("https://github.com/nycu-ucr/gin/pull/3969?key=value&otherkey=othervalue")
	require.NoError(t, err)
